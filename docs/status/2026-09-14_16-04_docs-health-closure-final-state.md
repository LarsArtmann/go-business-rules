...
2. **Is going public on GitHub part of this library's future?** ~~While private, the module proxy and pkg.go.dev could never index it~~ — resolved 2026-09-18: the repo went PUBLIC 2026-09-17 and pkg.go.dev now serves `v2.2.0`. The versioning question (`/v2` rename vs compatible tag) is largely meaningless until visibility is decided, and the README/badge story depends on it.
