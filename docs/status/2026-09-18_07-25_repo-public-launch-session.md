...
| # | Item                                             | Gap                                                                                                                                                                                                                                                             |
| - | ------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1 | Security-gate trust                              | The new fail-closed gosec job is _green_ in run `35305107107` per the parallel session's report, but **I never read its logs myself** to assert `Stats.files > 0`. The go-paperless lesson says a scanner must prove it scanned; the green badge alone doesn't. |
...
| 12 | GitHub account billing fix (still relevant for the ecosystem's _private_ repos; CI here no longer depends on it)                                                           |
